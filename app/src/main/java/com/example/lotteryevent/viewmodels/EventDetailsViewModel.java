...
public class EventDetailsViewModel extends ViewModel {
    ...
    // A helper class to represent all possible states of the bottom action bar.
    // This turns complex logic into simple, descriptive states for the UI.
    public static class BottomUiState {
        ...
        private BottomUiState(StateType type, String infoText, String positiveButtonText, String negativeButtonText) {
            this.type = type;
        ...
        public static BottomUiState loading() { return new BottomUiState(StateType.LOADING, null, null, null); }
        public static BottomUiState infoText(String text) { return new BottomUiState(StateType.SHOW_INFO_TEXT, text, null, null); }
        public static BottomUiState oneButton(String text) { return new BottomUiState(StateType.SHOW_ONE_BUTTON, null, text, null); }
        public static BottomUiState twoButtons(String pos, String neg) { return new BottomUiState(StateType.SHOW_TWO_BUTTONS, null, pos, neg); }
    }
